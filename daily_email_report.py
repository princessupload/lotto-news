...
# JACKPOT OPTIMIZED - #1 ranked number at each position + #1 bonus (Jan 23, 2026)
# All numbers are rank #1 in their position to maximize jackpot probability
USER_HOLD_TICKETS = {
    'l4l': {
        'main': [1, 12, 30, 39, 47], 'bonus': 11,
